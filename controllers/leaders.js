...
async function getdropdowndata(req, res) {
    try {
        ...
        const provincia = await sequelize.query(`select * from usuarios_provincia order by nombre` , { type: sequelize.QueryTypes.SELECT })
   ...
   console.log(att,"attendance")
    for(var i in att){
        ...
        request.post({
            ...
            url: 'https://basededatos.sgipanama.com:8080/api/dev/admin/getAttendance',
            json: {
